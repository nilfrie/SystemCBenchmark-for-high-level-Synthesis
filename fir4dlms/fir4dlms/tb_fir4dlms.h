//
// Header file to define the behaviour of the testbench for the fir4dlms module.
//

#include "define.h"

#ifndef TEST_FIR4DLMS_H
#define TEST_FIR4DLMS_H

SC_MODULE(test_fir4dlms) {
	// Inputs
	sc_in_clk clk;
	sc_in<bool> rst;
